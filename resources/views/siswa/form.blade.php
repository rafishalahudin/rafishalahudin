      ...
      <div class="box">
        ...
        <div class="box-body">
            ...
            {{csrf_field()}}
                ...
                <div class="checkbox">
                <label>
                <input type="radio" name="jenis_kelamin" value="L" {{ (@$result->jenis_kelamin == 'L' ? 'checked' : '') }} /> L</label>
                <label>
                <input type="radio" name="jenis_kelamin" value="P" {{ (@$result->jenis_kelamin == 'P' ? 'checked' : '') }} /> P</label>
                </div>
                </div>
                </div>
                ...
                <div class="col-sm-10">
                <textarea name="alamat" class="form-control" placeholder="Masukan Alamat" >{{ @$result->alamat }}</textarea> 
                </div>
                </div>
                ...
                @foreach (\App\Kelas::all() as $kelas)
                  <option value="{{ $kelas->id_kelas }}" {{ @$result->id_kelas == $kelas->id_kelas ? 'selected' : '' }}>
                    {{ $kelas->nama_kelas}}
                  </option>
                  @endforeach
                ...
                <div class="form-group">
                <div class="col-sm-10 colsm-offset-2">
